...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'operador', 'viewer', name='role', create_type=True, checkfirst=True), nullable=False),
    sa.Column('active', sa.Boolean(), nullable=False),
    ...
    sa.Column('status', sa.Enum('draft', 'confirmed', 'invoiced', 'cancelled', name='quotestatus', create_type=True, checkfirst=True), nullable=False),
